...
grafico_aposentados_totais_df = pd.read_csv('grafico_aposentados_totais_01_11.csv')

# Filtrar as respostas completas
grafico_aposentados_completas_df = pd.read_csv('grafico_aposentados_completas_01_11.csv')

# Filtrar as respostas incompletas
grafico_aposentados_incompletas_df = pd.read_csv('grafico_aposentados_incompletas_01_11.csv')
...
with tab_1:
        ...
        with st.container():
                ...
                with col_1:
                        col_1.metric('Respostas Totais:', 160)
                        
                # Criar a métrica de países registrados
                with col_2:
                        col_1.metric('Respostas Completas:', 81)
                        
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletas:', 79)
                        
                # Criar a métrica do total de avaliações feitas
                with col_4:
                        col_1.metric('Instituições de Ensino Citadas:', 41)
        ...
        with st.container():
                ...
                # Criar a métrica de restaurantes registrados
                with col_1:
                        col_1.metric('Respostas Totais:', 29)
                ...
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletas:', 13)
...
with tab_2:
    ...
    fig = px.bar(grafico_aposentados_totais_df, x='uf_instituicao', y='contagem', color='instituicao',
                ...
                title='Respostas Totais por UF e Instituição de Ensino (01/11/2024) - Aposentados Não-ativos')
    ...
    tabela_aposentados_totais_df = pd.read_csv('tabela_aposentados_totais_01_11.csv')
...
with tab_3:
    ...
    fig = px.bar(grafico_aposentados_completas_df, x='uf_instituicao', y='contagem', color='instituicao',
                labels = {'uf_instituicao':'UF', 'contagem':'Respostas completas',
                        'instituicao':'Instituição de ensino'},
                title='Respostas Completas por UF e Instituição de Ensino (01/11/2024) - Aposentados Não-ativos')
    fig.update_yaxes(tick0=0, dtick=10)
    fig.update_layout(showlegend=False)
    st.plotly_chart(fig, use_container_width=True)
    ...
    tabela_aposentados_completas_df = pd.read_csv('tabela_aposentados_completas_01_11.csv')
...
with tab_4:
    ...
    fig = px.bar(grafico_aposentados_incompletas_df, x='uf_instituicao', y='contagem', color='instituicao',
                labels = {'uf_instituicao':'UF', 'contagem':'Respostas incompletas',
                        'instituicao':'Instituição de ensino'},
                title='Respostas Incompletas por UF e Instituição de Ensino (01/11/2024) - Aposentados Não-ativos')
    fig.update_yaxes(tick0=0, dtick=10)
    fig.update_layout(showlegend=False)
    st.plotly_chart(fig, use_container_width=True)
    ...
    tabela_aposentados_incompletas_df = pd.read_csv('tabela_aposentados_incompletas_01_11.csv')
