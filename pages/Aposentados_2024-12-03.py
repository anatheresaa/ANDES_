...
grafico_aposentados_totais_df = pd.read_csv('grafico_aposentados_totais_03_12.csv')

# Filtrar as respostas completas
grafico_aposentados_completas_df = pd.read_csv('grafico_aposentados_completas_03_12.csv')

# Filtrar as respostas incompletas
grafico_aposentados_incompletas_df = pd.read_csv('grafico_aposentados_incompletas_03_12.csv')
...
with tab_1:
        ...
        with st.container():
                ...
                with col_1:
                        col_1.metric('Respostas Totais:', 368)
                        
                # Criar a métrica de países registrados
                with col_2:
                        col_1.metric('Respostas Completas:', 192)
                        
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletas:', 176)
                        
                # Criar a métrica do total de avaliações feitas
                with col_4:
                        col_1.metric('Instituições de Ensino Citadas:', 52)

        # Criar as métricas semenais
        with st.container():
                st.title('Crescimento Semanal (26/11/2024 a 11/12/2024)')
                col_1, col_2, col_3, col_4 = st.columns(4, gap='large')
                
                # Criar a métrica de restaurantes registrados
                with col_1:
                        col_1.metric('Respostas Totais:', 79)
                        
                # Criar a métrica de países registrados
                with col_2:
                        col_1.metric('Respostas Completas:', 47)
                        
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletas:', 32)
                        
                # Criar a métrica do total de avaliações feitas
                with col_4:
                        col_1.metric('Instituições de Ensino Citadas:', 7)
...
with tab_2:
    ...
    tabela_aposentados_totais_df = pd.read_csv('tabela_aposentados_totais_03_12.csv')
...
with tab_3:
    ...
    tabela_aposentados_completas_df = pd.read_csv('tabela_aposentados_completas_03_12.csv')
...
with tab_4:
    ...
    tabela_aposentados_incompletas_df = pd.read_csv('tabela_aposentados_incompletas_03_12.csv')
