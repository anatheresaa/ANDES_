...
grafico_ativos_totais_df = pd.read_csv('tabela_ativos_totais_31_01.csv')
...
grafico_ativos_completos_df = pd.read_csv('tabela_ativos_completos_31_01.csv')
...
grafico_ativos_incompletos_df = pd.read_csv('tabela_ativos_incompletos_31_01.csv')
...
with tab_1:
        ...
        with st.container():
                ...
                with col_1:
                        col_1.metric('Respostas Totais:', 4946)
                        
                # Criar a métrica de países registrados
                with col_2:
                        col_1.metric('Respostas completos:', 3144)
                        
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletos:', 1802)
        ...
        with st.container():
                ...
                # Criar a métrica de países registrados
                with col_2:
                        col_1.metric('Respostas completos:', 24)
                        
                # Criar a métrica de cidades registrados
                with col_3:
                        col_1.metric('Respostas Incompletos:', 18)
...
with tab_2:
    ...
    fig = px.bar(grafico_ativos_totais_df, x='UF', y='Contagem', color='Instituição de ensino',
                ...
                title='Respostas Totais por UF e Instituição de Ensino (31/01/2025) - Ativos')
    ...
    tabela_ativos_totais_df = pd.read_csv('tabela_ativos_totais_31_01.csv')
...
with tab_3:
    ...
    fig = px.bar(grafico_ativos_completos_df, x='UF', y='Contagem', color='Instituição de ensino',
                labels = {'UF':'UF', 'Contagem':'Respostas completos',
                        'Instituição de ensino':'Instituição de ensino'},
                title='Respostas completos por UF e Instituição de Ensino (31/01/2025) - Ativos')
    fig.update_yaxes(tick0=0, dtick=10)
    fig.update_layout(showlegend=False)
    st.plotly_chart(fig, use_container_width=True)
    ...
    tabela_ativos_completos_df = pd.read_csv('tabela_ativos_completos_31_01.csv')
...
with tab_4:
    ...
    fig = px.bar(grafico_ativos_incompletos_df, x='UF', y='Contagem', color='Instituição de ensino',
                labels = {'UF':'UF', 'Contagem':'Respostas incompletos',
                        'Instituição de ensino':'Instituição de ensino'},
                title='Respostas Incompletos por UF e Instituição de Ensino (31/01/2025) - Ativos')
    fig.update_yaxes(tick0=0, dtick=10)
    fig.update_layout(showlegend=False)
    st.plotly_chart(fig, use_container_width=True)
    ...
    tabela_ativos_incompletos_df = pd.read_csv('tabela_ativos_incompletos_31_01.csv')
